    ...
    public class ApplicationDbContext : IdentityDbContext<User, Role, Guid>, IDataProtectionKeyContext
    {
        ...
        private void SeedApplications(ModelBuilder builder)
        {
            builder.Entity<Application>().HasData(
                ...
                new Application
                {
                      Id = Guid.Parse("0f5bc658-7223-4c5a-b272-31e878f181d6"),
        ...
        private void SeedCompanies(ModelBuilder builder)
        {
            builder.Entity<Company>().HasData(
                new Company
                {
                    ...
                    ParentCompanyId = Guid.Parse("e8528a43-2a9d-44dd-b1c9-e37777ad0644")
                },
                new Company
                {
        ...
        private ICollection<Role> SeedRoles(ModelBuilder builder)
        {
            var roles = new List<Role>()
            {
                ...
                new Role
                {
                    Id = Guid.Parse("12dde740-ddde-42db-a4b9-5a2355082391"),
        ...
        private ICollection<User> SeedUsers(ModelBuilder builder)
        {
            ...
            var users = new List<User>()
            {
                ...
                new User
                {
                    Id = Guid.Parse("b6091148-6b17-4e26-9dc7-97d1b34fb025"),
        ...
        private void SeedUserRoles(ModelBuilder builder)
        {
            builder.Entity<IdentityUserRole<Guid>>().HasData(
                ...
                new IdentityUserRole<Guid>
                {
                    RoleId = Guid.Parse("12dde740-ddde-42db-a4b9-5a2355082391"),
                    UserId = Guid.Parse("b6091148-6b17-4e26-9dc7-97d1b34fb025")
                }
            );
        }
        #endregion Seeds

...
namespace Alize.Platform.Data.Migrations
{
    ...
    [Migration("20220512165125_AddBlockchains")]
    partial class AddBlockchains
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alize.Platform.Data.Models.ApplicationCredentials", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Alize.Platform.Data.Models.Blockchain", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Alize.Platform.Data.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "448c181e-d1c7-474a-8d2a-00c7be53543a",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "6bf0ea09-dbba-463e-9397-a7b74a0fa81a",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "3cc2aa14-9cfa-4816-adf4-c80eb34a52a9",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b533456c-94fe-48e4-b38b-f2780daec71b",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "86c867d9-b635-4e8e-a27f-7f1a5330ee7e",
            ...
            modelBuilder.Entity("Alize.Platform.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "5aeb564c-adfc-498f-a6c4-10ba56a3dc06",
                            Email = "test@user.com",
                            EmailConfirmed = true,
                            FirstName = "Test",
                            IsActive = true,
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAfG8nw1UU9TVoKQsgzall5IsnfkgVip/QCSLNBKNvi6/3NJuvDNp+uCQGWwUwLkiQ==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            CompanyId = new Guid("554bc4f7-46a9-4a87-a52e-6ca79e24986c"),
                            ConcurrencyStamp = "d0e484c5-c814-4d16-94ed-8e42bc15c425",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEFiWgAVjRsd19P8UgTAP5B+OIu2JyovqPn6Wxd0SQJzl/OQktQSdzzlMWbAeagdrBw==",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
                            UserName = "testadmin"
                        });
            ...
            modelBuilder.Entity("Alize.Platform.Data.Models.ApplicationCredentials", b =>
                {
                    b.HasOne("Alize.Platform.Data.Models.Application", "Application")
                        .WithMany()
                        .HasForeignKey("ApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Alize.Platform.Data.Models.Blockchain", "Blockchain")
                        .WithMany()
